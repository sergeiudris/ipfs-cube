torrent-search
a desktop program to search torrents

program

- decentralized peer-to-peer program to search torrent files
- automated index - program crawles torrent network, forming the index of files
...
- DHT - program uses existing DHT to find other programs to share index (additional field to DHT's ping to discover/ask and ut_metadata-like extension to then download index)
